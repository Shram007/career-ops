...
> **⚠️ ROUTING AGENT: DO NOT EDIT THIS FILE.** Read it and pass its full content to a subagent. Never rewrite, simplify, or update this file based on portals.yml contents. It is a permanent specification, not a per-run snapshot.
