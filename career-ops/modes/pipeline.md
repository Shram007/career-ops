...
**Nota:** Las fechas (YYYY-MM-DD) ahora aparecen automáticamente en entradas nuevas añadidas por el scanner. Esto facilita filtrar por antiguedad y evitar ofertas expiradas (> 7 días). Las entradas antiguas sin fecha se procesarán igual.
