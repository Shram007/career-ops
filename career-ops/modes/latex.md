...
12. Write to `output/Shram_Kadia_{Company}_{Role}.tex`
13. Run: `node generate-latex.mjs output/Shram_Kadia_{Company}_{Role}.tex output/Shram_Kadia_{Company}_{Role}.pdf`
